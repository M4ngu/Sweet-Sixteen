...
// for pitch bend use CC value 127
...
void checkDefaultSettings() {
 ...
 void initializeFactorySettings() {
  ...
  EEPROM.write(0,0); // LED ON
  EEPROM.write(1,0); // LED DATA
  EEPROM.write(2,1); // ROTATE   EEPROM.write(2,0)
  EEPROM.write(3,1); // I2C follower by default EEPROM.write(3,0)
  EEPROM.write(4,20); // fadermin LSB
  EEPROM.write(5,0); // fadermin MSB
  EEPROM.write(6,36); // fadermax LSB
