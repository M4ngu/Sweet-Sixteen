 ...
 */
// mod for pitchbend by Mangu Díaz
#include "config.h"
#include <i2c_t3.h>
#include <MIDI.h>
...
// int volatile currentValue2[channelCount]; // esto seria para hacerpitch bend y cc con un mismo fader...mangu
